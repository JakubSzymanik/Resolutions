...
namespace Resolutions.Server.Migrations
{
    ...
    [Migration("20240125124240_BussinessConfigurationConstantsAdded")]
    partial class BussinessConfigurationConstantsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resolutions.Server.Model.ResolutionEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ResolutionEventTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResolutionEventTypeId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Resolutions.Server.Model.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Resolutions.Server.Model.ResolutionEvent", b =>
                {
                    b.HasOne("Resolutions.Server.Model.ResolutionEventType", "ResolutionEventType")
                        .WithMany()
                        .HasForeignKey("ResolutionEventTypeId");

                    b.HasOne("Resolutions.Server.Model.Resolution", null)
                        .WithMany("ResolutionEvents")
